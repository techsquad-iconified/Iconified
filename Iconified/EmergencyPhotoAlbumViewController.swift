//
//  EmergencyPhotoAlbumViewController.swift
//  Iconified
//
...
class EmergencyPhotoAlbumViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var delegate: emerencyPhotoViewDelegate?
    ...
    {
        let cell: EmergencyPhotoCollectionViewCell = photoCollectionView.dequeueReusableCell(withReuseIdentifier: reuserIdentifier, for: indexPath) as! EmergencyPhotoCollectionViewCell
