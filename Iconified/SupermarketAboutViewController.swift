//
//  SupermarketAboutViewController.swift
//  Iconified
//
...
protocol marketaboutViewDelegate {
    func generateSegue(type: String)
}

import UIKit

class SupermarketAboutViewController: UIViewController {
    ...
    //delegate
    var delegate: marketaboutViewDelegate?
