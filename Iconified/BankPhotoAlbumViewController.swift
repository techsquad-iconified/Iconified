...
protocol bphotoViewDelegate {
    func photoSegue(selectedImageIndex: Int, photoArray: [UIImage])
}

import UIKit

class BankPhotoAlbumViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var delegate: bphotoViewDelegate?
