//
//  EmergencyAboutViewController.swift
//  Iconified
//
...
class EmergencyAboutViewController: UIViewController {
    ...
    //delegate
    var delegate: emegencyAboutViewDelegate?
    ...
    func updateLabels()
    {
        if(self.selectedPlace?.address != nil)
        {
